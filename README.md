...
```
## [<img src="https://github.com/AfriwanAhda/FileDemo/blob/master/toast.gif" width="28.1" height="50" alt="Toast Demo" target="_blank"/>](https://diponten.com/2019/07/08/toast/)    &nbsp;&nbsp;    Dynamic Toast
